...
if HADOOP_STREAMING_JAR is None:
    try:
        HADOOP_STREAMING_JAR = glob.glob("/usr/local/hadoop/contrib/streaming/hadoop-streaming-1.0.3.jar")[0]
    except IndexError:
        HADOOP_STREAMING_JAR = "/usr/local/hadoop/contrib/streaming/hadoop-streaming-1.0.3.jar"
